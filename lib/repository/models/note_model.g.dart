...
int serializeNoteModel(IsarWriter writer, NoteModel object) {
  ...
  IsarCore.writeLong(
      writer,
      5,
      object.updateDate?.toUtc().microsecondsSinceEpoch ??
          -9223372036854775808);
  IsarCore.writeLong(
      writer, 6, object.creationDate.toUtc().microsecondsSinceEpoch);
  return object.id;
}
...
NoteModel deserializeNoteModel(IsarReader reader) {
  ...
  final bool _checked;
  _checked = IsarCore.readBool(reader, 3);
...
class _NoteModelUpdateImpl implements _NoteModelUpdate {
  ...
  bool call({
    ...
    return collection.updateProperties([
          ...
          if (updateDate != ignore) 5: updateDate as DateTime?,
          if (creationDate != ignore) 6: creationDate as DateTime?,
        }) >
        0;
  }
}
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> updateDateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> updateDateEqualTo(
    DateTime? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition>
      updateDateGreaterThanOrEqualTo(
    DateTime? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> updateDateLessThan(
    DateTime? value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> updateDateBetween(
    DateTime? lower,
    DateTime? upper,
  ) {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQuerySortBy on QueryBuilder<NoteModel, NoteModel, QSortBy> {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByUpdateDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(5);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> sortByUpdateDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQuerySortThenBy
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByUpdateDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(5);
    });
  }

  QueryBuilder<NoteModel, NoteModel, QAfterSortBy> thenByUpdateDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(5, sort: Sort.desc);
    });
  }
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterDistinct> distinctByUpdateDate() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty1
  ...
  QueryBuilder<NoteModel, DateTime?, QAfterProperty> updateDateProperty() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty2<R>
  ...
  QueryBuilder<NoteModel, (R, DateTime?), QAfterProperty> updateDateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addProperty(5);
    });
  }
