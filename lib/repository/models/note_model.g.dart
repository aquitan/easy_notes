...
void _noteModelSerialize(
  ...
  writer.writeDateTime(offsets[5], object.updateDate);
}
...
extension NoteModelQueryWhereDistinct
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByChecked() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QDistinct> distinctByUpdateDate() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryProperty
  ...
  QueryBuilder<NoteModel, bool, QQueryOperations> checkedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, DateTime?, QQueryOperations> updateDateProperty() {
    return QueryBuilder.apply(this, (query) {
